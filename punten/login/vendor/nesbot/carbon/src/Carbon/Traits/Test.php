...
trait Test
{
    ...
    /**
     * A login Carbon instance to be returned when now instances are created.
     *
     ...
     *
     * To clear the login instance call this method using the default
     * parameter of null.
     *
    ...
    /**
     * Determine if there is a valid login instance set. A valid login instance
     * is anything that is not null.
     *
     * @return bool true if there is a login instance, otherwise false
     */
