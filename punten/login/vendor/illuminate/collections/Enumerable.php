...
interface Enumerable extends Arrayable, Countable, IteratorAggregate, Jsonable, JsonSerializable
{
    ...
    /**
     * Determine if all items pass the given truth login.
     *
     * @param  (callable(TValue, TKey): bool)|TValue|string  $key
     * @param  mixed  $operator
     * @param  mixed  $value
    ...
    /**
     * Get the first item from the enumerable passing the given truth login.
     *
    ...
    /**
     * Create a collection of all elements that do not pass a given truth login.
     *
